...
addpath('/user/ccolon/Dropbox/PhD/4. models/jpb/model/');

folder = '/home/ccolon/DDlocal/experiment/jpb/bif_n10c3_both/';
last_n_values = 1000;
...
[Tfinal, n, fixed_nb_suppliers_on_off, mean_nb_suppliers, nb_extra_suppliers, init_hh_wealth ...
    ...
    , rewiring, metropolis, lambda, nbSwitchTested, nbRewiringTried, rho] = setParameters(10,3);
...
%         fprintf('ITERATION (rep=%i, production_friction=%g)\n',rep, production_friction);
    ...
    for it2=1:nb_it2
        ...
        price_friction = production_friction;
